            ...
            <div className="flex flex-col gap-5">
                ...
                <div>
                    ...
                    <div className="flex gap-3 items-center">
                        <input type="text" value="k3j34k422jlj2kuh2lijku6hkuh6i5jij65iuygjghhiukyhkkjhkuh" className="border border-slate-500 p-2 rounded-md w-80"/>
                ...
                <div  className="">
                    ...
                    <div className="flex gap-3 items-center">
                    <input type="text" value={params.btcPrice} className="border border-slate-500 p-2 rounded-md w-80"/>
                    <button className="bg-gradient-to-tl from-blue-900 to-black text-white p-2 h-10 rounded-md text-sm">Copy</button>
                    </div>
                </div>
                <div>
