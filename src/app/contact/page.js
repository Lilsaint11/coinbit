    ...
    return ( 
        <div  className="bg-gradient-to-tl from-blue-900 to-black pb-10 px-28 max-[875px]:px-20 max-[700px]:px-10  max-[420px]:px-5 max-[800px]:pt-32 max-[770px]:pt-28 pt-28 flex max-[770px]:flex-col min-[770px]:items-center min-[770px]:justify-center text-white min-[770x]:h-screen">{/*pl-72 h-screen*/ }
            <div className="w-1/2 max-[770px]:w-full">
                ...
                <Link href="/signup"><button className="bg-white text-black p-2 w-40 max-[400px]:w-28  max-[400px]:text-[10px] rounded-2xl flex items-center gap-1"><IoLogoWhatsapp className="text-lg text-green-800"/>Via WhatsApp</button></Link>
                <Link href="/signup"><button className="bg-white text-black p-2 w-40  max-[400px]:w-28  max-[400px]:text-[13px] rounded-2xl  flex items-center gap-1"><BiMailSend className="text-lg text-black"/>Via Email</button></Link>
                </div>
